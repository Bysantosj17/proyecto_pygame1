...
carpeta_img_menu = os.path.join(carpeta_assets, "imagenes")
carp_img_fondo = os.path.join(carpeta_img_menu, "fondo")
#print(carp_img_fondo)
...
class Menu_game:
    def __init__(self):
        ...
        self.fondo = pygame.transform.scale(pygame.image.load(os.path.join(carp_img_fondo,"fondo_1.png")).convert(), (screen_width, screen_height))
